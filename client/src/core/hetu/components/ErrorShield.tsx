...
const ErrorShield: React.FC<ErrorShieldProps> = ({
  ...
  >
    ...
    >
      <p style={{ fontSize: 11, letterSpacing: '0.2em', color: '#64748B', marginBottom: 8 }}>
        HeTu ErrorShield · {code}
      </p>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, color: '#1A434E', marginBottom: 12 }}>
        {title}
      </h1>
      <p style={{ fontSize: 14, lineHeight: 1.6, color: '#64748B', marginBottom: 24 }}>
        {message}
      </p>
      {onRetry && (
        <button
